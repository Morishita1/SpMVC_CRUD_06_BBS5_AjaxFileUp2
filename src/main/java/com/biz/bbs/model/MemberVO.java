...
@AllArgsConstructor
@ToString
@ScriptAssert(lang="javascript", script = "_this.m_password == _this.m_re_password", reportOn = "m_re_password", message = "비밀번호와 비밀번호 확인이 일치하지 않습니다")
public class MemberVO {
	...
	@Pattern(regexp = "//d{1,15}",message = "전화번호는 숫자 1자리부터 15자리까지 사용할수 있습니다")
